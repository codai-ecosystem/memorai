...
describe('AnalyticsDashboard', () => {    beforeEach(() => {
    ...
    it('should display memory metrics', () => {
        ...
        // Should show total memories count (use getAllByText for duplicate values)
        expect(screen.getByText('Total Memories')).toBeInTheDocument()
        expect(screen.getAllByText('2')).toHaveLength(2) // We have 2 memories mocked
    })
