...
export class ErrorBoundary extends Component<Props, State> {
    ...
    private reportError = (error: Error, errorInfo: ErrorInfo, level: string): void => {
      ...
      `}
        ...
        >
            <div className="flex flex-col items-center space-y-4 max-w-md">
                {/* Error Icon */}
                <div className={`p-4 rounded-full ${isCritical ? 'bg-red-200' : 'bg-red-100'}`}>
                    {isCritical ? (
                ...
                <h2 className="text-xl font-semibold text-red-800">
                    {isCritical ? 'Critical Error' : isComponentLevel ? 'Component Error' : 'Application Error'}
                </h2>
 ...
 */
export function PageErrorBoundary({ children, ...props }: Omit<Props, 'level'>): React.ReactElement {
    return (
 ...
 */
export function ComponentErrorBoundary({ children, ...props }: Omit<Props, 'level'>): React.ReactElement {
    return (
 ...
 */
export function CriticalErrorBoundary({ children, ...props }: Omit<Props, 'level'>): React.ReactElement {
    return (
