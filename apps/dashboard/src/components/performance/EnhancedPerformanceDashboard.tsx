...
export default function PerformanceMonitoringDashboard() {
    ...
    try {
      ...
      if (response.ok) {
        ...
        announceToScreenReader(
          `Metrics updated. System health: ${data.systemHealth}. Memory usage: ${formatBytes(data.memoryUsage)}.`,
        );
      }
    } catch (error) {
      void console.error("Failed to fetch performance metrics:", error);
      void announceToScreenReader(
        "Failed to fetch performance metrics. Please check connection.",
      );
    } finally {
      setIsLoading(false);
    }
  ...
  return (
    <div
      className={`min-h-screen p-6 ${highContrast ? "contrast-more bg-black text-white" : "bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900"}`}
    >
      ...
      >
            ...
            <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-lg dark:bg-gray-800/80 hover:shadow-xl transition-all duration-300">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <Progress
                    value={
                      (metrics.memoryUsage / (8 * 1024 * 1024 * 1024)) * 100
                    }
                    className="h-3"
              ...
              <div className="space-y-4">
                {metrics.cacheHitRate < 80 && (
                  <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                    ...
                    <p className="text-sm mt-1">
                      Cache hit rate is below optimal. Consider increasing cache
                      size or reviewing cache policies.
                    </p>
                  </div>
                )}
                ...
                {metrics.averageQueryTime > 1000 && (
                  <div className="p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                    ...
                    <p className="text-sm mt-1">
                      Query performance is below target. Consider running memory
                      optimization or checking Qdrant configuration.
                    </p>
                  </div>
                )}
                ...
                {metrics.duplicatesFound > 1000 && (
                  <div className="p-4 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg">
                    ...
                    <p className="text-sm mt-1">
                      High number of duplicate memories detected. Run
                      optimization to improve performance and reduce memory
                      usage.
                    </p>
                  </div>
                )}
        ...
        >
          <p>
            MemorAI Enterprise Dashboard • Built with ❤️ for world-class
            performance
          </p>
          <p className="mt-1">
