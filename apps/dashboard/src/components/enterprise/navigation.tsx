...
export function EnterpriseNavigation({ collapsed, onToggle, activeTab, onTabChange, 'data-testid': dataTestId }: SidebarProps) {
                ...
                <AnimatePresence mode="wait">
                    {!collapsed && (
                        ...
                        >
                            ...
                            </div>                            <div>                                <h2 className="text-lg font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                                Memorai Dashboard
                            </h2>
                                <p className="text-xs text-muted-foreground line-clamp-2">Memorai Dashboard running in development mode | Server: Operational</p>
                            </div>
                        </motion.div>
                    )}
                </AnimatePresence>
                    ...
                    return (
                        ...
                        >                            <Button
                            ...
                            className={cn(
                                ...
                                isActive && "bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/50 dark:to-purple-950/50 border border-blue-200/50 dark:border-blue-800/50 shadow-sm",
                                !collapsed && "px-3",
                                            ...
                                            {item.badge && (
                                                <Badge
                                                    ...
                                                    className={cn(
                                                        ...
                                                        item.badge === 'Pro' && "bg-gradient-to-r from-orange-400 to-pink-400 text-white",
                                                        item.badge === 'New' && "bg-gradient-to-r from-blue-400 to-purple-400 text-white"
                                                    )}
                                                >
                                                    {item.badge}
                                                </Badge>
                    ...
                    <AnimatePresence mode="wait">
                        {!collapsed && (
                            ...
                            >
                                ...
                                <p className="text-xs text-muted-foreground truncate">Enterprise User</p>
                            </motion.div>
                        )}
                    </AnimatePresence>
                </div>
