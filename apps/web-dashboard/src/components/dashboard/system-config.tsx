...
export function SystemConfiguration({ className }: SystemConfigurationProps) {
    const { config, isLoading, updateConfig, fetchConfig, testConnection } = useConfigStore()
        ...
        <div className={cn('space-y-6', className)}>
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-600">Manage memory engine and system settings</p>
                </div>
                ...
                >
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Core memory processing settings</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) => handleConfigChange('memory', 'provider', e.target.value)}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => handleConfigChange('memory', 'model', e.target.value)}
                                className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => handleConfigChange('memory', 'openaiApiKey', e.target.value)}
                                className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => handleConfigChange('memory', 'maxMemories', parseInt(e.target.value))}
                                className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                min="1"
                                max="100"
                            />
                        ...
                        <div className="flex items-center gap-2">
                            <input
                                ...
                                onChange={(e) => handleConfigChange('memory', 'enableCache', e.target.checked)}
                                className="rounded"
                            />
                            <label htmlFor="enableMemoryCache" className="text-sm text-gray-700">
                ...
                >
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Vector storage and retrieval</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => handleConfigChange('database', 'collection', e.target.value)}
                                className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => handleConfigChange('database', 'dimensions', parseInt(e.target.value))}
                                className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                min="128"
                                max="4096"
                            />
                ...
                >
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Authentication and encryption</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-2">
                            <input
                                ...
                                className="rounded"
                            />
                            <label htmlFor="enableEncryption" className="text-sm text-gray-700">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => handleConfigChange('security', 'encryptionKey', e.target.value)}
                                className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                placeholder={showSecrets ? '32-character encryption key' : '••••••••••••••••'}
                            />
                        </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-2">
                            <input
                                ...
                                onChange={(e) => handleConfigChange('performance', 'enablePreloading', e.target.checked)}
                                className="rounded"
                            />
                            <label htmlFor="enablePreloading" className="text-sm text-gray-700">
