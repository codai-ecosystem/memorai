...
export function MemoryActions({ className }: MemoryActionsProps) {
    ...
    const [type, setType] = useState<'conversation' | 'document' | 'note' | 'thread' | 'task' | 'personality' | 'emotion'>('note')
            ...
            {isAddingMemory && (
                ...
                >
                    ...
                    >{/* Content */}
                        ...
                        {/* Type */}
                        <div>
                            <label htmlFor="memory-type" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                Type
                            </label>
                            <select
                                id="memory-type"
                        ...
                        {/* Tags */}
                        <div>
                            <label htmlFor="memory-tags" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                Tags
                            </label>
                        ...
                        {/* Importance */}
                        <div>
                            <label htmlFor="memory-importance" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
