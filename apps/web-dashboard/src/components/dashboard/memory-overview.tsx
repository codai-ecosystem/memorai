...
import { Brain, Users, TrendingUp, Clock, AlertCircle, CheckCircle } from 'lucide-react'
...
export function MemoryOverview({ className }: MemoryOverviewProps) {
    const { stats, memories, isLoading, error, fetchStats, fetchMemories } = useMemoryStore()

    useEffect(() => {
        fetchStats()
        fetchMemories({ limit: 5 })
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-medium text-gray-600 dark:text-gray-400">
                                ...
                                {isLoading ? '---' : stats?.totalMemories?.toLocaleString('en-US') || '0'}
                            </p>
                        </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <div className="mt-4 flex items-center text-sm">
                        ...
                        <span className="text-gray-600 dark:text-gray-400">All agents healthy</span>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-gray-900 dark:text-white">
                                {isLoading ? '--' : `${Math.round((stats?.averageImportance || 0) * 100)}%`}
                            </p>
                        </div>
