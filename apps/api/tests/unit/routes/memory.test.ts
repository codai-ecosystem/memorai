...
import { createMockMemoryEngine, createFailingMemoryEngine, generateTestMemory } from '../../helpers/testHelpers';
...
describe('Memory Routes', () => {
    ...
    describe('POST /context', () => {
        ...
        it('should handle memory not found', async () => {
            ...
            expect(response.body.error).toBe('Memory not found or could not be deleted');
    ...
    describe('GET /list/:agentId', () => {
        ...
        it('should handle search parameter', async () => {
            ...
            await request(app)
                ...
                .expect(200); expect(mockMemoryEngine.recall).toHaveBeenCalledWith(
                    'test query',
                    'default',
                    agentId,
