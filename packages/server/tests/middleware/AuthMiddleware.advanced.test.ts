...
describe('AuthMiddleware Advanced Coverage', () => {
  ...
  describe('Token Validation Edge Cases', () => {
    it('should handle production token validation failure', async () => {
      ...
      await prodAuth.authenticate(mockRequest as FastifyRequest, mockReply as FastifyReply);
  ...
  describe('Static Permission Methods', () => {
    ...
    it('should check permissions correctly', () => {
      expect(AuthMiddleware.hasPermission(mockAuthContext, 'memory:read')).toBe(true);
      expect(AuthMiddleware.hasPermission(mockAuthContext, 'memory:delete')).toBe(false);
    });
    ...
    it('should handle wildcard permissions', () => {
      ...
      expect(AuthMiddleware.hasPermission(adminAuth, 'any:permission')).toBe(true);
    });
