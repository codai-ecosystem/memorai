...
describe('MemoryCache - Comprehensive Coverage', () => {
  ...
  describe('Search Functionality', () => {
    ...
    it('should return multiple matching results sorted by relevance', async () => {      const memory4: AgentMemory = {
        id: 'mem4',
    ...
    it('should handle empty content in memories', async () => {      const memoryWithoutContent: AgentMemory = {
        id: 'mem_no_content',
        content: '',
        context: {
          sessionId: 'test-session'
  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    it('should handle relevance score calculation edge cases', async () => {      const memoryWithSpecialChars: AgentMemory = {
        id: 'mem_special',
