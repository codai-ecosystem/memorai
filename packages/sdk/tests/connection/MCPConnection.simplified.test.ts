...
describe('MCPConnection - Simplified Tests', () => {
    ...
    describe('JSON-RPC Request Handling', () => {
        ...
        it('should throw error when not connected', async () => {
            ...
            await expect(connection.send(request)).rejects.toThrow('MCP connection not established');
        });
    ...
    describe('Direct Memory Operations', () => {
        ...
        it('should remember successfully', async () => {
            ...
            await expect(connection.remember('test-agent', 'test content')).resolves.not.toThrow();
        ...
        it('should forget successfully', async () => {
            ...
            await expect(connection.forget('test-agent', 'mem123')).resolves.not.toThrow();
        });
    });
});
