...
export class TemporalEngine {
  ...
  calculateTimeDecay(
    ...
    const daysSinceAccess =
      (currentTime.getTime() - memory.lastAccessedAt.getTime()) /
      (1000 * 60 * 60 * 24);
