...
import { MemoryConfigManager, MemoryConfigFactory } from '../../src/config/MemoryConfig.js';
...
describe('MemoryConfigManager', () => {
  ...
  beforeEach(() => {
    ...
    process.env.MEMORY_ENCRYPTION_KEY = 'test-encryption-key-32-characters-long';
  });
  ...
  describe('Configuration Loading', () => {
    ...
    it('should handle environment variables for defaults', () => {
      ...
      process.env.MEMORY_ENCRYPTION_KEY = 'env-encryption-key-32-characters-long';
      ...
      expect(config.security.encryption_key).toBe('env-encryption-key-32-characters-long');
    });
  });
  ...
  describe('Configuration Access Methods', () => {
    ...
    it('should provide security configuration', () => {
      ...
      expect(securityConfig.encryption_key).toBe('test-encryption-key-32-characters-long');
  ...
  describe('Configuration Validation', () => {
    it('should validate encryption key length', () => {
      ...
      expect(() => new MemoryConfigManager(invalidConfig)).toThrow('Encryption key must be at least 32 characters long');
    });
  ...
  describe('Edge Cases', () => {    it('should handle undefined override values', () => {
    ...
    it('should handle complex nested overrides', () => {      const complexConfig = {
        vector_db: {
      ...
      expect(config.security.encryption_key).toBe('complex-encryption-key-32-characters-long');
